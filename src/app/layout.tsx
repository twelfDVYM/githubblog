...
export const metadata: Metadata = {
  ...
  description:
    "A modern blog platform powered by Next.js and GitHub Markdown, customised for DrakensbergMassage.co.za",
  openGraph: {
    ...
    images: [
      {
        url: "https://V-Urquhart.github.io/DBMHost/DBMLogoWeb.png", // Add your own OG image
        width: 1200,
        height: 630,
